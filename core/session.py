...
from core.gsa import load_relevant_skills, sink_failure_to_gsa  # ★ GSA
...
# Handlers and schemas live in core.gsa_tools; imported here (not at top
# level) so tool registration order is unchanged.
from core.gsa_tools import (  # noqa: E402
...
_TOOL_REGISTRY.register(ToolSpec(
    "bump_skill", tool_bump_skill, BUMP_SKILL_SCHEMA,
...
_TOOL_REGISTRY.register(ToolSpec(
    "audit_payload", tool_audit_payload, AUDIT_PAYLOAD_SCHEMA,
